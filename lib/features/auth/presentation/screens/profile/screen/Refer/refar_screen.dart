...
class RefarScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String refarCode =
        ProfileCubit.get(context).userDetails?.refarCode ?? AppStrings.appName;
    onShare() async {
                        ...
                        children: [
                          InkWell(
                              onTap: () async {
                                ...
                                EasyLoading.showToast(AppStrings.copied , toastPosition: EasyLoadingToastPosition.bottom);
                              },
